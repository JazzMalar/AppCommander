...
namespace AppCommander.Model
{
    ...
    /// Dankeschön an Stackoverflow User Nick Cravers
    /// </summary>
    [Serializable]
    public class XMLVersion : ICloneable, IComparable
    {
        private int major;
        private int minor;
        private int build;
        ...
        /// <summary>
        /// Creates a new <see cref="XMLVersion"/> instance.
        /// </summary>
        public XMLVersion()
        {
            this.build = -1;
        ...
        public XMLVersion(int major, int minor)
        {
            this.build = -1;
            this.revision = -1;
            if (major < 0)
        ...
        public XMLVersion(int major, int minor, int build)
        {
            this.build = -1;
            this.revision = -1;
            if (major < 0)
        ...
        public XMLVersion(int major, int minor, int build, int revision)
        {
            this.build = -1;
            this.revision = -1;
            if (major < 0)
        ...
        public object Clone()
        {
            XMLVersion version1 = new XMLVersion();
        ...
        public int CompareTo(object version)
        {
            ...
            if (!(version is XMLVersion))
            {
                throw new ArgumentException("Arg_MustBeVersion");
            }
            XMLVersion version1 = (XMLVersion)version;
        ...
        {
            if ((obj == null) || !(obj is XMLVersion))
            {
                return false;
            }
            XMLVersion version1 = (XMLVersion)obj;
        ...
        /// <returns></returns>
        public static bool operator ==(XMLVersion v1, XMLVersion v2)
        {
            return v1.Equals(v2);
        }
        /// <summary>
